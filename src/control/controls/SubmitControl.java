 ...
 * un control XForm Submit. 
 *
 * @Author      Mauricio Rodriguez
 * @Versión     1.0, 25/01/2005
 */

public class SubmitControl extends JControl {
	 ...
	 * 						   control.
	 */
	public SubmitControl(DocTable docTable, DocTree docTree, XmlDoc xmldoc, JEditPanel editPanel) {
		super(editPanel);
	 ...
	 */
	public SubmitControl(DocTable docTable, DocTree docTree, Element repeatControl, JEditPanel editPanel) {
		super(editPanel);
    	this.docTree = docTree;
    	this.docTable = docTable;
    	this.table = docTable.getTable();
	 ...
	 * 						   control.
	 */
    public SubmitControl(int CONTROL_X, int X1, int Y1, int X2, int Y2, DocTable docTable, 
		...
		this.properties = new Properties(this.jTable,this.table);
		this.setControlType("submit");
		if(CONTROL_X != 0) this.setName("Submit_"+CONTROL_X);
		else this.setName("Submit");
		this.updateControl();
		shapesVisible(false);
    }
