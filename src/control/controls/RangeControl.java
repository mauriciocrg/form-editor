/* 
* nombre del archivo: RangeControl.java
*  
 ...
 * un control XForm Range. 
 *
 * @Author      Mauricio Rodriguez
 * @Versión     1.0, 25/01/2005
 */

public class RangeControl extends JControl {
	
	private JSlider jSlider;				//representa a un control range.
	 ...
	 * 						   control.
	 */
	public RangeControl(DocTable docTable, DocTree docTree, XmlDoc xmldoc, JEditPanel editPanel) {
		super(editPanel);
		...
		this.xmldoc = xmldoc;
		jSlider = new JSlider();
		jSlider.setLocation(ANCHO_EXTRA / 2, ALTO_EXTRA / 2);
	 ...
	 */
	public RangeControl(DocTable docTable, DocTree docTree, Element repeatControl, JEditPanel editPanel) {
		super(editPanel);
    	this.docTree = docTree;
    	this.docTable = docTable;
    	this.table = docTable.getTable();
	 ...
	 * 						   control.
	 */
	public RangeControl(int CONTROL_X, int X1, int Y1, int X2, int Y2, DocTable docTable, 
		...
		this.xmldoc = xmldoc;
		jSlider = new JSlider();
		jSlider.setBounds(ANCHO_EXTRA / 2, ALTO_EXTRA / 2, X2 - X1, ALTO);
		...
		this.addActionListener(actionEvent);
		this.setControlType("range");
		if(CONTROL_X != 0) this.setName("Range_"+CONTROL_X);
		else this.setName("Range");
		this.updateControl();
		shapesVisible(false);
    }
	...
	public void reDraw() {
		rect.setVisible(false);
		jSlider.setSize(getWidth() - ANCHO_EXTRA, ALTO);
