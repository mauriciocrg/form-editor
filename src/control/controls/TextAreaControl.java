 ...
 * un control XForm TextArea. 
 *
 * @Author      Mauricio Rodriguez
 * @Versión     1.0, 25/01/2005
 */

public class TextAreaControl extends JControl {

	private JTextArea jTextArea;		//representa a un control textarea. 	
	private JScrollPane jScrollPane;	//contiene al jTextArea
	 ...
	 * 						   control.
	 */	
	public TextAreaControl(DocTable docTable, DocTree docTree, XmlDoc xmldoc, JEditPanel editPanel) {
		super(editPanel);
	 ...
	 * @param	    docTable   Es el DocTable que es usado en FirstFrame.
	 * @param	    docTree    Es el DocTree que es usado en FirstFrame.
	 * @param	    xmldoc     Es el Element la que pertenece este control.
	 */	
	public TextAreaControl(DocTable docTable, DocTree docTree, Element repeatControl, JEditPanel editPanel) {
		super(editPanel);
		this.docTree = docTree;
		this.docTable = docTable;
		this.table = docTable.getTable();
	 ...
	 * 						   control.
	 */
	public TextAreaControl(int control_x, int X1, int Y1, int X2, int Y2, DocTable docTable, 
		...
		this.properties = new Properties(this.jTable,this.table);
		this.setControlType("textArea");
		if(control_x != 0) this.setName("TextArea_"+control_x);
		else this.setName("TextArea");
		this.updateControl();
		shapesVisible(false);
	}
	...
	public void reDraw() {
		...
		jTextArea.setSize(getWidth() - ANCHO_EXTRA, getHeight() - ALTO_EXTRA);
