 ...
 * un control XForm Output.  
 *
 * @Author      Mauricio Rodriguez
 * @Versión     1.0, 25/01/2005
 */

public class OutputControl extends JControl {
	 ...
	 * 						   control.
	 */
	public OutputControl(DocTable docTable, DocTree docTree, XmlDoc xmldoc, JEditPanel editPanel) {
		super(editPanel);
		...
		this.xmldoc = xmldoc;
		jLabel.setLocation(ANCHO_EXTRA / 2, ALTO_EXTRA / 2);
		this.setLayout(null);
		this.addActionListener(jLabel);
		this.add(jLabel, null);
		this.properties = new Properties(this.jTable, this.table);
		this.setControlType("output");
	}
	 ...
	 * @param	    docTable   		Es el DocTable que es usado en FirstFrame.
	 * @param	    docTree    		Es el DocTree que es usado en FirstFrame.
	 * @param	    repeatControl   Es el Element repeatControl al que pertenece este conrol.
	 */
	public OutputControl(DocTable docTable, DocTree docTree, Element repeatControl,JEditPanel editPanel) {
		super(editPanel);
		this.docTree = docTree;
		this.docTable = docTable;
		this.table = docTable.getTable();
	 ...
	 * 						   control.
	 */
	public OutputControl(int CONTROL_X, int X1, int Y1, int X2, int Y2, DocTable docTable, 
		...
		jLabel.setBounds(ANCHO_EXTRA / 2, ALTO_EXTRA / 2, X2 - X1, ALTO);
		this.setLayout(null);
		this.addActionListener(jLabel);
		...
		this.properties = new Properties(this.jTable,this.table);
		this.setControlType("output");
		if(CONTROL_X != 0) this.setName("Output_"+CONTROL_X);
		else this.setName("Output");
		this.updateControl();
		shapesVisible(false);
	}
	 ...
	 * @param	    docTable   		Es el DocTable que es usado en FirstFrame.
	 * @param	    docTree    		Es el DocTree que es usado en FirstFrame.
	 * @param	    repeatControl   Es el Element repeatControl al que pertenece este control.
	 */
	public OutputControl(int CONTROL_X, int X1, int Y1, int X2, int Y2, DocTable docTable, 
	...
	public void reDraw() {
		rect.setVisible(false);
		jLabel.setSize((getWidth() - ANCHO_EXTRA), ALTO);
		setLocationShapes();
	}
