/* 
* nombre del archivo: LabelControl.java
*  
 ...
 * un control XForm Label.  
 *
 * @Author      Mauricio Rodriguez
 * @Versión     1.0, 25/01/2005
 */

public class LabelControl extends JControl{
	 ...
	 * 						   control.
	 */
	public LabelControl(DocTable docTable, DocTree docTree, XmlDoc xmldoc, JEditPanel editPanel) {
		super(editPanel);
	 ...
	 * @param	    docTable   		Es el DocTable que es usado en FirstFrame.
	 * @param	    docTree    		Es el DocTree que es usado en FirstFrame.
	 * @param	    repeatControl   Es el Element repeat al que pertenece ente control.
	 */
	public LabelControl(DocTable docTable, DocTree docTree, Element repeatControl, JEditPanel editPanel) {
		super(editPanel);
		this.docTree = docTree;
		this.docTable = docTable;
		this.table = docTable.getTable();
	 ...
	 * 						   control.
	 */
	public LabelControl(int CONTROL_X, int X1, int Y1, int X2, int Y2, DocTable docTable, 
		...
		this.properties = new Properties(this.jTable,this.table);
		this.setControlType("label");
		if(CONTROL_X != 0) jLabel.setText("Label_"+CONTROL_X);
		this.setName(jLabel.getText());
		this.updateControl();
		shapesVisible(false);
	}
	 ...
	 * @param	    docTable   Es el DocTable que es usado en FirstFrame.
	 * @param	    docTree    Es el DocTree que es usado en FirstFrame.
	 * @param	    xmldoc     Es el Element repeatControl al que pertenece estre control.
	 */
	public LabelControl(int CONTROL_X, int X1, int Y1, int X2, int Y2, DocTable docTable, 
