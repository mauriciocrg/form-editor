 ...
 * un control XForm Secret. 
 *
 * @Author      Mauricio Rodriguez
 * @Versión     1.0, 25/01/2005
 */

public class SecretControl extends JControl {
	
	private JPasswordField jPasswordField;  //representa a un control secret.
	 ...
	 * 						   control.
	 */
	public SecretControl(DocTable docTable, DocTree docTree, XmlDoc xmldoc, JEditPanel editPanel) {
		super(editPanel);
		...
		jPasswordField.setLocation(ANCHO_EXTRA / 2, ALTO_EXTRA / 2);
		this.setLayout(null);
		this.addActionListener(actionEvent);
		this.add(actionEvent, null);
		this.add(jPasswordField, null);
		this.setControlType("secret");
	 ...
	 */
	public SecretControl(DocTable docTable, DocTree docTree, Element repeatControl, JEditPanel editPanel) {
		super(editPanel);
		this.docTree = docTree;
    	this.docTable = docTable;
    	this.table = docTable.getTable();
	 ...
	 * 						   control.
	 */
    public SecretControl(int CONTROL_X, int X1, int Y1, int X2, int Y2, DocTable docTable, 
		...
		jPasswordField.setBounds(ANCHO_EXTRA / 2, ALTO_EXTRA / 2, X2 - X1, ALTO);
		this.setLayout(null);
		this.addActionListener(actionEvent);
		...
		this.properties = new Properties(this.jTable, this.table);
		this.setControlType("secret");
		if(CONTROL_X != 0) this.setName("Secret_"+CONTROL_X);
		else this.setName("Secret");
		this.updateControl();
		shapesVisible(false);
    }
	...
	public void reDraw() {
		rect.setVisible(false);
		jPasswordField.setSize((getWidth() - ANCHO_EXTRA), ALTO);
