...
/*
 * Esta clase extiende de JControl y contiene las caracteristicas y propiedades de 
 * un control XForm Input. 
 *
 * @Author      Mauricio Rodriguez
 * @Versión     1.0, 25/01/2005
 */

public class InputControl extends JControl {
	
	private JTextField JTF;					//Equivalente a el control input
	 ...
	 * 						   control.
	 */
	public InputControl(DocTable docTable, DocTree docTree, XmlDoc xmldoc,JEditPanel editPanel) {
		super(editPanel);
		this.xmldoc = xmldoc;
	 ...
	 * @param	    docTable   		Es el DocTable que es usado en FirstFrame.
	 * @param	    docTree    		Es el DocTree que es usado en FirstFrame.
	 * @param	    repeatControl   Es un Element repeat.
	 */
	public InputControl(DocTable docTable, DocTree docTree, Element repeatControl,JEditPanel editPanel) {
		super(editPanel);
	 ...
	 * 						   control.
	 */
	public InputControl(int CONTROL_X, int X1, int Y1, int X2, int Y2, DocTable docTable, 
		...
		JTF.setBounds(ANCHO_EXTRA / 2, ALTO_EXTRA / 2, X2 - X1, ALTO);
		this.setLayout(null);
		...
		this.properties = new Properties(this.jTable, this.table);
		this.setControlType("input");
		if(CONTROL_X != 0) this.setName("Input_"+CONTROL_X);
		else this.setName("Input");
		this.updateControl();
		shapesVisible(false);
	}
	 ...
	 * @param	    docTable   		Es el DocTable que es usado en FirstFrame.
	 * @param	    docTree    		Es el DocTree que es usado en FirstFrame.
	 * @param	    repeatControl 	Es el control repeat al que pertenece.
	 */
	public InputControl(int CONTROL_X, int X1, int Y1, int X2, int Y2, DocTable docTable, 
	...
	public void reDraw() {
		rect.setVisible(false);
		JTF.setSize((getWidth() - ANCHO_EXTRA), ALTO);
